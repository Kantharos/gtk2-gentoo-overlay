...
IUSE="+base -bluetooth gtk3 +notification +themes +extras"
...
RDEPEND="
	...
	themes? (
		...
		=x11-themes/mate-themes-meta-1.10*:0
	)
	extras? (
...
#using mate-system-monitor-1.12.* because of gtk2 support being dropped in 1.13.x/1.14.0
#using x11-misc/mozo-1.13.0 because of gtk2 support being dropped in 1.13.1/1.14.0
